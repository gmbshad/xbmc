...
static void ndr_print_flags_netlogon_creds_CredentialState(struct ndr_print *ndr, const char *name, int unused, const struct netlogon_creds_CredentialState *r)
{
...
static void ndr_print_flags_netlogon_cache_entry(struct ndr_print *ndr, const char *name, int unused, const struct netlogon_cache_entry *r)
{
...
static void ndr_print_flags_NL_AUTH_MESSAGE(struct ndr_print *ndr, const char *name, int unused, const struct NL_AUTH_MESSAGE *r)
{
...
static void ndr_print_flags_NL_AUTH_SIGNATURE(struct ndr_print *ndr, const char *name, int unused, const struct NL_AUTH_SIGNATURE *r)
{
...
static void ndr_print_flags_NL_AUTH_SHA2_SIGNATURE(struct ndr_print *ndr, const char *name, int unused, const struct NL_AUTH_SHA2_SIGNATURE *r)
{
