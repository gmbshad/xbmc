...
static enum ndr_err_code ndr_pull_Delete(struct ndr_pull *ndr, int flags, struct Delete *r)
{
	...
	if (flags & NDR_IN) {
		...
		NDR_CHECK(ndr_steal_array_size(ndr, (void*)&r->in.wszName, &size_wszName_1));
		NDR_CHECK(ndr_steal_array_length(ndr, (void*)&r->in.wszName, &length_wszName_1));
...
#ifndef SKIP_NDR_TABLE_IWbemClassObject
static const struct ndr_interface_public_struct IWbemClassObject_public_structs[] = {
	{ .name = NULL }
};
...
const struct ndr_interface_table ndr_table_IWbemClassObject = {
	...
	.public_structs		= IWbemClassObject_public_structs,
	.endpoints	= &IWbemClassObject_endpoints,
	.authservices	= &IWbemClassObject_authservices
};

#endif /* SKIP_NDR_TABLE_IWbemClassObject */
#include "librpc/gen_ndr/ndr_orpc.h"
...
static enum ndr_err_code ndr_pull_QueryObjectSink(struct ndr_pull *ndr, int flags, struct QueryObjectSink *r)
{
	...
	if (flags & NDR_IN) {
		...
		NDR_ZERO_STRUCTP(r->out.ppResponseHandler);
	}
	if (flags & NDR_OUT) {
#ifdef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
#endif /* FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION */
...
static enum ndr_err_code ndr_pull_GetObjectAsync(struct ndr_pull *ndr, int flags, struct GetObjectAsync *r)
{
	...
	if (flags & NDR_OUT) {
		...
		if (r->in.pResponseHandler == NULL) {
			NDR_PULL_ALLOC(ndr, r->in.pResponseHandler);
			NDR_ZERO_STRUCTP(r->in.pResponseHandler);
		}
#endif /* FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION */
		if (ndr->flags & LIBNDR_FLAG_REF_ALLOC) {
			NDR_PULL_ALLOC(ndr, r->out.ORPCthat);
...
static enum ndr_err_code ndr_pull_ExecMethodAsync(struct ndr_pull *ndr, int flags, struct ExecMethodAsync *r)
{
	...
	if (flags & NDR_OUT) {
		...
		if (r->in.pInParams == NULL) {
			NDR_PULL_ALLOC(ndr, r->in.pInParams);
			NDR_ZERO_STRUCTP(r->in.pInParams);
		}
		if (r->in.pResponseHandler == NULL) {
			NDR_PULL_ALLOC(ndr, r->in.pResponseHandler);
			NDR_ZERO_STRUCTP(r->in.pResponseHandler);
...
#ifndef SKIP_NDR_TABLE_IWbemServices
static const struct ndr_interface_public_struct IWbemServices_public_structs[] = {
	{ .name = NULL }
};
...
const struct ndr_interface_table ndr_table_IWbemServices = {
	...
	.num_public_structs	= 0,
	.public_structs		= IWbemServices_public_structs,
	.endpoints	= &IWbemServices_endpoints,
	.authservices	= &IWbemServices_authservices
};

#endif /* SKIP_NDR_TABLE_IWbemServices */
#include "librpc/gen_ndr/ndr_orpc.h"
...
static enum ndr_err_code ndr_pull_IEnumWbemClassObject_Next(struct ndr_pull *ndr, int flags, struct IEnumWbemClassObject_Next *r)
{
	...
	if (flags & NDR_IN) {
		...
		NDR_ZERO_STRUCTP(r->out.puReturned);
	}
	if (flags & NDR_OUT) {
#ifdef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
#endif /* FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION */
		...
		NDR_CHECK(ndr_get_array_size(ndr, (void*)&r->out.apObjects, &size_apObjects_1));
		NDR_CHECK(ndr_get_array_length(ndr, (void*)&r->out.apObjects, &length_apObjects_1));
		...
		if (r->out.apObjects) {
			NDR_CHECK(ndr_check_steal_array_length(ndr, (void*)&r->out.apObjects, *r->out.puReturned));
		}
		for (cntr_apObjects_1 = 0; cntr_apObjects_1 < (length_apObjects_1); cntr_apObjects_1++) {
		}
	}
...
#ifndef SKIP_NDR_TABLE_IEnumWbemClassObject
static const struct ndr_interface_public_struct IEnumWbemClassObject_public_structs[] = {
	{ .name = NULL }
};
...
const struct ndr_interface_table ndr_table_IEnumWbemClassObject = {
	...
	.num_public_structs	= 0,
	.public_structs		= IEnumWbemClassObject_public_structs,
	.endpoints	= &IEnumWbemClassObject_endpoints,
	.authservices	= &IEnumWbemClassObject_authservices
};

#endif /* SKIP_NDR_TABLE_IEnumWbemClassObject */
#include "librpc/gen_ndr/ndr_orpc.h"
...
static enum ndr_err_code ndr_pull_Clone(struct ndr_pull *ndr, int flags, struct Clone *r)
{
	...
	if (flags & NDR_IN) {
		...
		NDR_ZERO_STRUCTP(r->out.ppNewCopy);
	}
	if (flags & NDR_OUT) {
#ifdef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
#endif /* FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION */
...
#ifndef SKIP_NDR_TABLE_IWbemContext
static const struct ndr_interface_public_struct IWbemContext_public_structs[] = {
	{ .name = NULL }
};
...
const struct ndr_interface_table ndr_table_IWbemContext = {
	...
	.num_public_structs	= 0,
	.public_structs		= IWbemContext_public_structs,
	.endpoints	= &IWbemContext_endpoints,
	.authservices	= &IWbemContext_authservices
};

#endif /* SKIP_NDR_TABLE_IWbemContext */
#include "librpc/gen_ndr/ndr_orpc.h"
...
static enum ndr_err_code ndr_pull_EstablishPosition(struct ndr_pull *ndr, int flags, struct EstablishPosition *r)
{
	...
	if (flags & NDR_IN) {
		...
		if (r->in.wszLocaleList) {
			...
			NDR_CHECK(ndr_steal_array_size(ndr, (void*)&r->in.wszLocaleList, &size_wszLocaleList_1));
			NDR_CHECK(ndr_steal_array_length(ndr, (void*)&r->in.wszLocaleList, &length_wszLocaleList_1));
		...
		NDR_ZERO_STRUCTP(r->out.reserved);
	}
	if (flags & NDR_OUT) {
#ifdef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
#endif /* FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION */
...
static enum ndr_err_code ndr_pull_RequestChallenge(struct ndr_pull *ndr, int flags, struct RequestChallenge *r)
{
	...
	if (flags & NDR_IN) {
		...
		if (r->in.wszNetworkResource) {
			...
			NDR_CHECK(ndr_steal_array_size(ndr, (void*)&r->in.wszNetworkResource, &size_wszNetworkResource_1));
			NDR_CHECK(ndr_steal_array_length(ndr, (void*)&r->in.wszNetworkResource, &length_wszNetworkResource_1));
		...
		if (r->in.wszUser) {
			...
			NDR_CHECK(ndr_steal_array_size(ndr, (void*)&r->in.wszUser, &size_wszUser_1));
			NDR_CHECK(ndr_steal_array_length(ndr, (void*)&r->in.wszUser, &length_wszUser_1));
	...
	if (flags & NDR_OUT) {
		...
		NDR_CHECK(ndr_get_array_size(ndr, (void*)&r->out.Nonce, &size_Nonce_1));
		NDR_CHECK(ndr_get_array_length(ndr, (void*)&r->out.Nonce, &length_Nonce_1));
		...
		NDR_CHECK(ndr_pull_WERROR(ndr, NDR_SCALARS, &r->out.result));
		if (r->out.Nonce) {
			NDR_CHECK(ndr_check_steal_array_size(ndr, (void*)&r->out.Nonce, 16));
		}
		if (r->out.Nonce) {
			NDR_CHECK(ndr_check_steal_array_length(ndr, (void*)&r->out.Nonce, 16));
		}
	}
	return NDR_ERR_SUCCESS;
}
...
static enum ndr_err_code ndr_pull_WBEMLogin(struct ndr_pull *ndr, int flags, struct WBEMLogin *r)
{
	...
	if (flags & NDR_IN) {
		...
		if (r->in.wszPreferredLocale) {
			...
			NDR_CHECK(ndr_steal_array_size(ndr, (void*)&r->in.wszPreferredLocale, &size_wszPreferredLocale_1));
			NDR_CHECK(ndr_steal_array_length(ndr, (void*)&r->in.wszPreferredLocale, &length_wszPreferredLocale_1));
		...
		if (r->in.AccessToken) {
			...
			NDR_CHECK(ndr_get_array_size(ndr, (void*)&r->in.AccessToken, &size_AccessToken_1));
			NDR_CHECK(ndr_get_array_length(ndr, (void*)&r->in.AccessToken, &length_AccessToken_1));
		...
		NDR_ZERO_STRUCTP(r->out.ppNamespace);
		if (r->in.AccessToken) {
			NDR_CHECK(ndr_check_steal_array_size(ndr, (void*)&r->in.AccessToken, 16));
		}
		if (r->in.AccessToken) {
			NDR_CHECK(ndr_check_steal_array_length(ndr, (void*)&r->in.AccessToken, 16));
		}
	}
	if (flags & NDR_OUT) {
#ifdef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
...
#ifndef SKIP_NDR_TABLE_IWbemLevel1Login
static const struct ndr_interface_public_struct IWbemLevel1Login_public_structs[] = {
	{ .name = NULL }
};
...
const struct ndr_interface_table ndr_table_IWbemLevel1Login = {
	...
	.num_public_structs	= 0,
	.public_structs		= IWbemLevel1Login_public_structs,
	.endpoints	= &IWbemLevel1Login_endpoints,
	.authservices	= &IWbemLevel1Login_authservices
};

#endif /* SKIP_NDR_TABLE_IWbemLevel1Login */
#include "librpc/gen_ndr/ndr_orpc.h"
...
static enum ndr_err_code ndr_pull_IWbemWCOSmartEnum_Next(struct ndr_pull *ndr, int flags, struct IWbemWCOSmartEnum_Next *r)
{
	...
	if (flags & NDR_IN) {
		...
		NDR_ZERO_STRUCTP(r->out.pSize);
		NDR_PULL_ALLOC(ndr, r->out.pData);
		NDR_ZERO_STRUCTP(r->out.pData);
	}
	if (flags & NDR_OUT) {
#ifdef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
		if (r->in.gEWCO == NULL) {
			NDR_PULL_ALLOC(ndr, r->in.gEWCO);
			NDR_ZERO_STRUCTP(r->in.gEWCO);
		}
		if (r->in.gWCO == NULL) {
			NDR_PULL_ALLOC(ndr, r->in.gWCO);
			NDR_ZERO_STRUCTP(r->in.gWCO);
		}
#endif /* FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION */
		if (ndr->flags & LIBNDR_FLAG_REF_ALLOC) {
			NDR_PULL_ALLOC(ndr, r->out.ORPCthat);
		...
		if (*r->out.pData) {
			...
			NDR_CHECK(ndr_get_array_size(ndr, (void*)r->out.pData, &size_pData_2));
		...
		NDR_CHECK(ndr_pull_WERROR(ndr, NDR_SCALARS, &r->out.result));
		if (*r->out.pData) {
			NDR_CHECK(ndr_check_steal_array_size(ndr, (void*)r->out.pData, *r->out.pSize));
		}
	}
	return NDR_ERR_SUCCESS;
}
...
#ifndef SKIP_NDR_TABLE_IWbemWCOSmartEnum
static const struct ndr_interface_public_struct IWbemWCOSmartEnum_public_structs[] = {
	{ .name = NULL }
};
...
const struct ndr_interface_table ndr_table_IWbemWCOSmartEnum = {
	...
	.num_public_structs	= 0,
	.public_structs		= IWbemWCOSmartEnum_public_structs,
	.endpoints	= &IWbemWCOSmartEnum_endpoints,
	.authservices	= &IWbemWCOSmartEnum_authservices
};

#endif /* SKIP_NDR_TABLE_IWbemWCOSmartEnum */
#include "librpc/gen_ndr/ndr_orpc.h"
...
#ifndef SKIP_NDR_TABLE_IWbemFetchSmartEnum
static const struct ndr_interface_public_struct IWbemFetchSmartEnum_public_structs[] = {
	{ .name = NULL }
};
...
const struct ndr_interface_table ndr_table_IWbemFetchSmartEnum = {
	...
	.num_public_structs	= 0,
	.public_structs		= IWbemFetchSmartEnum_public_structs,
	.endpoints	= &IWbemFetchSmartEnum_endpoints,
	.authservices	= &IWbemFetchSmartEnum_authservices
};

#endif /* SKIP_NDR_TABLE_IWbemFetchSmartEnum */
#include "librpc/gen_ndr/ndr_orpc.h"
...
static enum ndr_err_code ndr_pull_GetResultObject(struct ndr_pull *ndr, int flags, struct GetResultObject *r)
{
	...
	if (flags & NDR_IN) {
		...
		NDR_ZERO_STRUCTP(r->out.ppResultObject);
	}
	if (flags & NDR_OUT) {
#ifdef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
#endif /* FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION */
...
static enum ndr_err_code ndr_pull_GetResultString(struct ndr_pull *ndr, int flags, struct GetResultString *r)
{
	...
	if (flags & NDR_IN) {
		...
		NDR_ZERO_STRUCTP(r->out.pstrResultString);
	}
	if (flags & NDR_OUT) {
#ifdef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
#endif /* FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION */
...
static enum ndr_err_code ndr_pull_GetResultServices(struct ndr_pull *ndr, int flags, struct GetResultServices *r)
{
	...
	if (flags & NDR_IN) {
		...
		NDR_ZERO_STRUCTP(r->out.ppServices);
	}
	if (flags & NDR_OUT) {
#ifdef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
#endif /* FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION */
...
static enum ndr_err_code ndr_pull_GetCallStatus(struct ndr_pull *ndr, int flags, struct GetCallStatus *r)
{
	...
	if (flags & NDR_IN) {
		...
		NDR_ZERO_STRUCTP(r->out.plStatus);
	}
	if (flags & NDR_OUT) {
#ifdef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
#endif /* FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION */
...
#ifndef SKIP_NDR_TABLE_IWbemCallResult
static const struct ndr_interface_public_struct IWbemCallResult_public_structs[] = {
	{ .name = NULL }
};
...
const struct ndr_interface_table ndr_table_IWbemCallResult = {
	...
	.num_public_structs	= 0,
	.public_structs		= IWbemCallResult_public_structs,
	.endpoints	= &IWbemCallResult_endpoints,
	.authservices	= &IWbemCallResult_authservices
};

#endif /* SKIP_NDR_TABLE_IWbemCallResult */
#include "librpc/gen_ndr/ndr_orpc.h"
...
static enum ndr_err_code ndr_pull_SetStatus(struct ndr_pull *ndr, int flags, struct SetStatus *r)
{
	...
	if (flags & NDR_OUT) {
		...
		if (r->in.pObjParam == NULL) {
			NDR_PULL_ALLOC(ndr, r->in.pObjParam);
			NDR_ZERO_STRUCTP(r->in.pObjParam);
		}
#endif /* FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION */
		if (ndr->flags & LIBNDR_FLAG_REF_ALLOC) {
			NDR_PULL_ALLOC(ndr, r->out.ORPCthat);
...
static enum ndr_err_code ndr_pull_Indicate(struct ndr_pull *ndr, int flags, struct Indicate *r)
{
	...
	if (flags & NDR_IN) {
		...
		NDR_CHECK(ndr_get_array_size(ndr, (void*)&r->in.apObjArray, &size_apObjArray_1));
		if (ndr->flags & LIBNDR_FLAG_REF_ALLOC) {
...
#ifndef SKIP_NDR_TABLE_IWbemObjectSink
static const struct ndr_interface_public_struct IWbemObjectSink_public_structs[] = {
	{ .name = NULL }
};
...
const struct ndr_interface_table ndr_table_IWbemObjectSink = {
	...
	.num_public_structs	= 0,
	.public_structs		= IWbemObjectSink_public_structs,
	.endpoints	= &IWbemObjectSink_endpoints,
	.authservices	= &IWbemObjectSink_authservices
};

#endif /* SKIP_NDR_TABLE_IWbemObjectSink */
