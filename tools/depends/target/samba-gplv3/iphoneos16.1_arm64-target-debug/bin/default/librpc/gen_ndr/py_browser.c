...
static PyObject *py_BrowserrQueryOtherDomains_ndr_print_in(PyObject *py_obj, PyObject *Py_UNUSED(ignored))
{
	return py_BrowserrQueryOtherDomains_ndr_print(py_obj, "BrowserrQueryOtherDomains_in", NDR_IN);
}

static PyObject *py_BrowserrQueryOtherDomains_ndr_print_out(PyObject *py_obj, PyObject *Py_UNUSED(ignored))
{
