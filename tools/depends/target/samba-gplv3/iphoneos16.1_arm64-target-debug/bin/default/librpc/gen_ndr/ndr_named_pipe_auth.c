...
_PUBLIC_ enum ndr_err_code ndr_push_named_pipe_auth_req_info4(struct ndr_push *ndr, int ndr_flags, const struct named_pipe_auth_req_info4 *r)
{
...
_PUBLIC_ enum ndr_err_code ndr_pull_named_pipe_auth_req_info4(struct ndr_pull *ndr, int ndr_flags, struct named_pipe_auth_req_info4 *r)
{
...
static void ndr_print_flags_named_pipe_auth_req_info4(struct ndr_print *ndr, const char *name, int unused, const struct named_pipe_auth_req_info4 *r)
{
	ndr_print_named_pipe_auth_req_info4(ndr, name, r);
}
...
static void ndr_print_flags_named_pipe_auth_req(struct ndr_print *ndr, const char *name, int unused, const struct named_pipe_auth_req *r)
{
...
static void ndr_print_flags_named_pipe_auth_rep(struct ndr_print *ndr, const char *name, int unused, const struct named_pipe_auth_rep *r)
{
...
static const struct ndr_interface_public_struct named_pipe_auth_public_structs[] = {
	{
		.name = "named_pipe_auth_req_info4",
		.struct_size = sizeof(struct named_pipe_auth_req_info4 ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_named_pipe_auth_req_info4,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_named_pipe_auth_req_info4,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_named_pipe_auth_req_info4,
	},
	{
