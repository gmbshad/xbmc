#include "config.h"
/* Generated from /Users/redd/kodi/tools/depends/target/samba-gplv3/iphoneos16.1_arm64-target-debug/source4/heimdal/lib/asn1/digest.asn1 */
/* Do not edit */
...
size_t tickets_tag_tag_for_oldret = ret;
ret = 0;
ret += der_length_octet_string(&((data)->tickets)->val[n_tickets_tag_tag - 1]);
ret += 1 + der_length_len (ret);
ret += tickets_tag_tag_for_oldret;
}
ret += tickets_tag_tag_oldret;
