#include "config.h"
/* Generated from /Users/redd/kodi/tools/depends/target/samba-gplv3/iphoneos16.1_arm64-target-debug/source4/heimdal/lib/asn1/pkinit.asn1 */
/* Do not edit */
...
size_t Top_tag_for_oldret = ret;
ret = 0;
ret += length_ExternalPrincipalIdentifier(&(data)->val[n_Top_tag - 1]);
ret += Top_tag_for_oldret;
}
ret += Top_tag_oldret;
}
...
{
size_t supportedCMSTypes_tag_tag_oldret = ret;
unsigned int n_supportedCMSTypes_tag_tag;
ret = 0;
for(n_supportedCMSTypes_tag_tag = ((data)->supportedCMSTypes)->len; n_supportedCMSTypes_tag_tag > 0; --n_supportedCMSTypes_tag_tag){
size_t supportedCMSTypes_tag_tag_for_oldret = ret;
ret = 0;
ret += length_AlgorithmIdentifier(&((data)->supportedCMSTypes)->val[n_supportedCMSTypes_tag_tag - 1]);
ret += supportedCMSTypes_tag_tag_for_oldret;
}
ret += supportedCMSTypes_tag_tag_oldret;
}
...
{
size_t supportedKDFs_tag_tag_oldret = ret;
unsigned int n_supportedKDFs_tag_tag;
ret = 0;
for(n_supportedKDFs_tag_tag = ((data)->supportedKDFs)->len; n_supportedKDFs_tag_tag > 0; --n_supportedKDFs_tag_tag){
size_t supportedKDFs_tag_tag_for_oldret = ret;
ret = 0;
ret += length_KDFAlgorithmId(&((data)->supportedKDFs)->val[n_supportedKDFs_tag_tag - 1]);
ret += supportedKDFs_tag_tag_for_oldret;
}
ret += supportedKDFs_tag_tag_oldret;
}
...
size_t Top_tag_for_oldret = ret;
ret = 0;
ret += length_AlgorithmIdentifier(&(data)->val[n_Top_tag - 1]);
ret += Top_tag_for_oldret;
}
ret += Top_tag_oldret;
}
...
{
size_t trusted_certifiers_tag_tag_oldret = ret;
unsigned int n_trusted_certifiers_tag_tag;
ret = 0;
for(n_trusted_certifiers_tag_tag = ((data)->trusted_certifiers)->len; n_trusted_certifiers_tag_tag > 0; --n_trusted_certifiers_tag_tag){
size_t trusted_certifiers_tag_tag_for_oldret = ret;
ret = 0;
ret += length_TrustedCA_Win2k(&((data)->trusted_certifiers)->val[n_trusted_certifiers_tag_tag - 1]);
ret += trusted_certifiers_tag_tag_for_oldret;
}
ret += trusted_certifiers_tag_tag_oldret;
}
