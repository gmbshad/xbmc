/* Generated from /Users/redd/kodi/tools/depends/target/samba-gplv3/iphoneos16.1_arm64-target-debug/source4/heimdal/lib/asn1/rfc2459.asn1 */
/* Do not edit */
...
{
size_t value_tag_oldret = ret;
unsigned int n_value_tag;
ret = 0;
for(n_value_tag = (&(data)->value)->len; n_value_tag > 0; --n_value_tag){
size_t value_tag_for_oldret = ret;
ret = 0;
ret += length_heim_any(&(&(data)->value)->val[n_value_tag - 1]);
...
size_t Top_tag_for_oldret = ret;
ret = 0;
ret += length_Extension(&(data)->val[n_Top_tag - 1]);
ret += Top_tag_for_oldret;
}
ret += Top_tag_oldret;
}
...
size_t Top_tag_for_oldret = ret;
ret = 0;
ret += length_Certificate(&(data)->val[n_Top_tag - 1]);
ret += Top_tag_for_oldret;
}
ret += Top_tag_oldret;
}
...
size_t Top_tag_for_oldret = ret;
ret = 0;
ret += length_GeneralName(&(data)->val[n_Top_tag - 1]);
ret += Top_tag_for_oldret;
}
ret += Top_tag_oldret;
}
...
{
size_t authorityCertIssuer_tag_oldret = ret;
unsigned int n_authorityCertIssuer_tag;
ret = 0;
for(n_authorityCertIssuer_tag = ((data)->authorityCertIssuer)->len; n_authorityCertIssuer_tag > 0; --n_authorityCertIssuer_tag){
size_t authorityCertIssuer_tag_for_oldret = ret;
ret = 0;
ret += length_GeneralName(&((data)->authorityCertIssuer)->val[n_authorityCertIssuer_tag - 1]);
ret += authorityCertIssuer_tag_for_oldret;
}
ret += authorityCertIssuer_tag_oldret;
}
...
size_t Top_tag_for_oldret = ret;
ret = 0;
ret += length_GeneralSubtree(&(data)->val[n_Top_tag - 1]);
ret += Top_tag_for_oldret;
}
ret += Top_tag_oldret;
}
...
{
size_t permittedSubtrees_tag_oldret = ret;
unsigned int n_permittedSubtrees_tag;
ret = 0;
for(n_permittedSubtrees_tag = ((data)->permittedSubtrees)->len; n_permittedSubtrees_tag > 0; --n_permittedSubtrees_tag){
size_t permittedSubtrees_tag_for_oldret = ret;
ret = 0;
ret += length_GeneralSubtree(&((data)->permittedSubtrees)->val[n_permittedSubtrees_tag - 1]);
ret += permittedSubtrees_tag_for_oldret;
}
ret += permittedSubtrees_tag_oldret;
}
...
{
size_t excludedSubtrees_tag_oldret = ret;
unsigned int n_excludedSubtrees_tag;
ret = 0;
for(n_excludedSubtrees_tag = ((data)->excludedSubtrees)->len; n_excludedSubtrees_tag > 0; --n_excludedSubtrees_tag){
size_t excludedSubtrees_tag_for_oldret = ret;
ret = 0;
ret += length_GeneralSubtree(&((data)->excludedSubtrees)->val[n_excludedSubtrees_tag - 1]);
ret += excludedSubtrees_tag_for_oldret;
}
ret += excludedSubtrees_tag_oldret;
}
...
size_t Top_tag_for_oldret = ret;
ret = 0;
ret += der_length_oid(&(data)->val[n_Top_tag - 1]);
ret += 1 + der_length_len (ret);
ret += Top_tag_for_oldret;
}
ret += Top_tag_oldret;
...
if ((&(data)->u.fullName)->len > 2147483647) {
e = ASN1_MAX_CONSTRAINT; goto fail;
}
...
{
size_t fullName_tag_oldret = ret;
unsigned int n_fullName_tag;
ret = 0;
for(n_fullName_tag = (&(data)->u.fullName)->len; n_fullName_tag > 0; --n_fullName_tag){
size_t fullName_tag_for_oldret = ret;
ret = 0;
ret += length_GeneralName(&(&(data)->u.fullName)->val[n_fullName_tag - 1]);
ret += fullName_tag_for_oldret;
}
ret += fullName_tag_oldret;
}
...
size_t Top_tag_for_oldret = ret;
ret = 0;
ret += length_DistributionPoint(&(data)->val[n_Top_tag - 1]);
ret += Top_tag_for_oldret;
}
ret += Top_tag_oldret;
}
...
{
size_t revokedCertificates_tag_oldret = ret;
unsigned int n_revokedCertificates_tag;
ret = 0;
for(n_revokedCertificates_tag = ((data)->revokedCertificates)->len; n_revokedCertificates_tag > 0; --n_revokedCertificates_tag){
size_t revokedCertificates_tag_for_oldret = ret;
ret = 0;
{
size_t revokedCertificates_tag_S_Of_tag_oldret = ret;
ret = 0;
ret += length_CertificateSerialNumber(&(&((data)->revokedCertificates)->val[n_revokedCertificates_tag - 1])->userCertificate);
ret += revokedCertificates_tag_S_Of_tag_oldret;
}
{
size_t revokedCertificates_tag_S_Of_tag_oldret = ret;
ret = 0;
ret += length_Time(&(&((data)->revokedCertificates)->val[n_revokedCertificates_tag - 1])->revocationDate);
ret += revokedCertificates_tag_S_Of_tag_oldret;
}
if((&((data)->revokedCertificates)->val[n_revokedCertificates_tag - 1])->crlEntryExtensions){
size_t revokedCertificates_tag_S_Of_tag_oldret = ret;
ret = 0;
ret += length_Extensions((&((data)->revokedCertificates)->val[n_revokedCertificates_tag - 1])->crlEntryExtensions);
ret += revokedCertificates_tag_S_Of_tag_oldret;
}
ret += 1 + der_length_len (ret);
ret += revokedCertificates_tag_for_oldret;
...
size_t Top_tag_for_oldret = ret;
ret = 0;
ret += length_AccessDescription(&(data)->val[n_Top_tag - 1]);
ret += Top_tag_for_oldret;
}
ret += Top_tag_oldret;
}
