/* Generated from /Users/redd/kodi/tools/depends/target/samba-gplv3/iphoneos16.1_arm64-target-debug/source4/heimdal/lib/asn1/cms.asn1 */
/* Do not edit */
...
ret = 0;
ret += length_DigestAlgorithmIdentifier(&(data)->val[n_Top_tag - 1]);
...
size_t Top_tag_for_oldret = ret;
ret = 0;
ret += length_heim_any(&(data)->val[n_Top_tag - 1]);
ret += Top_tag_for_oldret;
}
ret += Top_tag_oldret;
}
...
size_t Top_tag_for_oldret = ret;
ret = 0;
ret += length_CertificateList(&(data)->val[n_Top_tag - 1]);
ret += Top_tag_for_oldret;
}
ret += Top_tag_oldret;
}
...
size_t Top_tag_for_oldret = ret;
ret = 0;
ret += length_Attribute(&(data)->val[n_Top_tag - 1]);
ret += Top_tag_for_oldret;
}
ret += Top_tag_oldret;
}
...
{
size_t signedAttrs_tag_oldret = ret;
unsigned int n_signedAttrs_tag;
ret = 0;
for(n_signedAttrs_tag = ((data)->signedAttrs)->len; n_signedAttrs_tag > 0; --n_signedAttrs_tag){
size_t signedAttrs_tag_for_oldret = ret;
ret = 0;
ret += length_Attribute(&((data)->signedAttrs)->val[n_signedAttrs_tag - 1]);
...
{
size_t unsignedAttrs_tag_oldret = ret;
unsigned int n_unsignedAttrs_tag;
ret = 0;
for(n_unsignedAttrs_tag = ((data)->unsignedAttrs)->len; n_unsignedAttrs_tag > 0; --n_unsignedAttrs_tag){
size_t unsignedAttrs_tag_for_oldret = ret;
ret = 0;
ret += length_Attribute(&((data)->unsignedAttrs)->val[n_unsignedAttrs_tag - 1]);
...
size_t Top_tag_for_oldret = ret;
ret = 0;
ret += length_SignerInfo(&(data)->val[n_Top_tag - 1]);
ret += Top_tag_for_oldret;
}
ret += Top_tag_oldret;
}
...
{
size_t certificates_tag_oldret = ret;
unsigned int n_certificates_tag;
ret = 0;
for(n_certificates_tag = ((data)->certificates)->len; n_certificates_tag > 0; --n_certificates_tag){
size_t certificates_tag_for_oldret = ret;
ret = 0;
ret += length_heim_any(&((data)->certificates)->val[n_certificates_tag - 1]);
...
{
size_t certs_tag_oldret = ret;
unsigned int n_certs_tag;
ret = 0;
for(n_certs_tag = ((data)->certs)->len; n_certs_tag > 0; --n_certs_tag){
size_t certs_tag_for_oldret = ret;
ret = 0;
ret += length_heim_any(&((data)->certs)->val[n_certs_tag - 1]);
...
size_t Top_tag_for_oldret = ret;
ret = 0;
ret += length_RecipientInfo(&(data)->val[n_Top_tag - 1]);
ret += Top_tag_for_oldret;
}
ret += Top_tag_oldret;
}
