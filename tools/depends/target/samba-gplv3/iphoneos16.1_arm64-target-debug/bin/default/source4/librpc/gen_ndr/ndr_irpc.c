...
static void ndr_print_flags_irpc_header(struct ndr_print *ndr, const char *name, int unused, const struct irpc_header *r)
{
...
static void ndr_print_flags_irpc_name_record(struct ndr_print *ndr, const char *name, int unused, const struct irpc_name_record *r)
{
...
static void ndr_print_flags_irpc_name_records(struct ndr_print *ndr, const char *name, int unused, const struct irpc_name_records *r)
{
