...
_PUBLIC_ enum ndr_err_code ndr_push_NetProvisionFlags(struct ndr_push *ndr, int ndr_flags, uint32_t r)
{
	NDR_CHECK(ndr_push_uint32(ndr, NDR_SCALARS, r));
	return NDR_ERR_SUCCESS;
}

_PUBLIC_ enum ndr_err_code ndr_pull_NetProvisionFlags(struct ndr_pull *ndr, int ndr_flags, uint32_t *r)
{
	uint32_t v;
	NDR_CHECK(ndr_pull_uint32(ndr, NDR_SCALARS, &v));
	*r = v;
...
_PUBLIC_ enum ndr_err_code ndr_push_NetProvisionJoinFlags(struct ndr_push *ndr, int ndr_flags, uint32_t r)
{
	NDR_CHECK(ndr_push_uint32(ndr, NDR_SCALARS, r));
	return NDR_ERR_SUCCESS;
}

_PUBLIC_ enum ndr_err_code ndr_pull_NetProvisionJoinFlags(struct ndr_pull *ndr, int ndr_flags, uint32_t *r)
{
	uint32_t v;
	NDR_CHECK(ndr_pull_uint32(ndr, NDR_SCALARS, &v));
	*r = v;
...
_PUBLIC_ void ndr_print_NetProvisionComputerAccount(struct ndr_print *ndr, const char *name, int flags, const struct NetProvisionComputerAccount *r)
{
...
_PUBLIC_ void ndr_print_NetRequestOfflineDomainJoin(struct ndr_print *ndr, const char *name, int flags, const struct NetRequestOfflineDomainJoin *r)
{
