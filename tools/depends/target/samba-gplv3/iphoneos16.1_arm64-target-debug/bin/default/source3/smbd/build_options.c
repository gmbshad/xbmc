...
void build_options(bool screen)
{
	...
	/* Show HAVE_* Defines */
...
#endif
#ifdef HAVE_CHARSET_IBM850
       output(screen, "   HAVE_CHARSET_IBM850\n");
#endif
#ifdef HAVE_CHARSET_UTF8
       output(screen, "   HAVE_CHARSET_UTF8\n");
#endif
       ...
       output(screen, "   HAVE_GNUTLS_AEAD_CIPHER_ENCRYPTV2\n");
#endif
       ...
       output(screen, "   HAVE_GNUTLS_SET_DEFAULT_PRIORITY_APPEND\n");
#endif
#ifdef HAVE_GRANTPT
       ...
       output(screen, "   HAVE_SYSCALL_COPY_FILE_RANGE\n");
#endif
#ifdef HAVE_SYSCONF
	...
	/* Show Build Options */
...
#endif
#ifdef HEIMDAL_UNPICKY_WNO_MAYBE_UNINITIALIZED_CFLAGS
       output(screen, "   HEIMDAL_UNPICKY_WNO_MAYBE_UNINITIALIZED_CFLAGS\n");
#endif
       ...
       output(screen, "   _DARWIN_C_SOURCE\n");
#endif
#ifdef _DARWIN_UNLIMITED_GETGROUPS
       output(screen, "   _DARWIN_UNLIMITED_GETGROUPS\n");
#endif
#ifdef _GNU_SOURCE
...
#endif
#ifdef allow_heimdal_warnings
       output(screen, "   allow_heimdal_warnings\n");
#endif
#ifdef build_mvxattr
...
#endif
#ifdef cshlib_LINKFLAGS
       output(screen, "   cshlib_LINKFLAGS\n");
#endif
...
#endif
#ifdef enable_clangdb
       output(screen, "   enable_clangdb\n");
#endif
