...
static void ndr_print_flags_share_mode_entry(struct ndr_print *ndr, const char *name, int unused, const struct share_mode_entry *r)
{
...
static void ndr_print_flags_delete_token(struct ndr_print *ndr, const char *name, int unused, const struct delete_token *r)
{
...
_PUBLIC_ enum ndr_err_code ndr_push_share_mode_flags(struct ndr_push *ndr, int ndr_flags, uint16_t r)
{
	NDR_CHECK(ndr_push_uint16(ndr, NDR_SCALARS, r));
	return NDR_ERR_SUCCESS;
}

_PUBLIC_ enum ndr_err_code ndr_pull_share_mode_flags(struct ndr_pull *ndr, int ndr_flags, uint16_t *r)
{
	uint16_t v;
...
_PUBLIC_ enum ndr_err_code ndr_push_share_mode_data(struct ndr_push *ndr, int ndr_flags, const struct share_mode_data *r)
{
	...
	if (ndr_flags & NDR_SCALARS) {
		...
		NDR_CHECK(ndr_push_NTTIME(ndr, NDR_SCALARS, r->old_write_time));
...
_PUBLIC_ enum ndr_err_code ndr_pull_share_mode_data(struct ndr_pull *ndr, int ndr_flags, struct share_mode_data *r)
{
	...
	if (ndr_flags & NDR_SCALARS) {
		...
		NDR_CHECK(ndr_pull_NTTIME(ndr, NDR_SCALARS, &r->old_write_time));
		NDR_CHECK(ndr_pull_NTTIME(ndr, NDR_SCALARS, &r->changed_write_time));
		/* [skip] 'r->fresh' */
		NDR_ZERO_STRUCT(r->fresh);
		/* [skip] 'r->modified' */
...
static void ndr_print_flags_share_mode_data(struct ndr_print *ndr, const char *name, int unused, const struct share_mode_data *r)
{
...
_PUBLIC_ void ndr_print_share_mode_data(struct ndr_print *ndr, const char *name, const struct share_mode_data *r)
{
	...
	ndr->depth--;
	ndr_print_NTTIME(ndr, "old_write_time", r->old_write_time);
...
_PUBLIC_ enum ndr_err_code ndr_push_vfs_default_durable_cookie(struct ndr_push *ndr, int ndr_flags, const struct vfs_default_durable_cookie *r)
{
	...
	if (ndr_flags & NDR_SCALARS) {
		...
		NDR_CHECK(ndr_push_NTTIME(ndr, NDR_SCALARS, r->close_write_time));
...
_PUBLIC_ enum ndr_err_code ndr_pull_vfs_default_durable_cookie(struct ndr_pull *ndr, int ndr_flags, struct vfs_default_durable_cookie *r)
{
	...
	if (ndr_flags & NDR_SCALARS) {
		...
		NDR_CHECK(ndr_pull_NTTIME(ndr, NDR_SCALARS, &r->close_write_time));
...
static void ndr_print_flags_vfs_default_durable_cookie(struct ndr_print *ndr, const char *name, int unused, const struct vfs_default_durable_cookie *r)
{
...
_PUBLIC_ void ndr_print_vfs_default_durable_cookie(struct ndr_print *ndr, const char *name, const struct vfs_default_durable_cookie *r)
{
	...
	ndr_print_NTTIME(ndr, "close_write_time", r->close_write_time);
	ndr_print_vfs_default_durable_stat(ndr, "stat_info", &r->stat_info);
	ndr->depth--;
}

_PUBLIC_ enum ndr_err_code ndr_push_oplock_break_message(struct ndr_push *ndr, int ndr_flags, const struct oplock_break_message *r)
{
	NDR_PUSH_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
...
_PUBLIC_ enum ndr_err_code ndr_pull_oplock_break_message(struct ndr_pull *ndr, int ndr_flags, struct oplock_break_message *r)
{
	NDR_PULL_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
...
static void ndr_print_flags_oplock_break_message(struct ndr_print *ndr, const char *name, int unused, const struct oplock_break_message *r)
{
...
_PUBLIC_ enum ndr_err_code ndr_push_file_rename_message(struct ndr_push *ndr, int ndr_flags, const struct file_rename_message *r)
{
	NDR_PUSH_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_push_align(ndr, 5));
...
_PUBLIC_ enum ndr_err_code ndr_pull_file_rename_message(struct ndr_pull *ndr, int ndr_flags, struct file_rename_message *r)
{
	uint32_t _ptr_servicepath;
	uint32_t size_servicepath_1 = 0;
	uint32_t length_servicepath_1 = 0;
...
static void ndr_print_flags_file_rename_message(struct ndr_print *ndr, const char *name, int unused, const struct file_rename_message *r)
{
