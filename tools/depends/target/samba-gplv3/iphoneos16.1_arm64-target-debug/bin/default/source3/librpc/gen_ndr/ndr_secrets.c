...
static void ndr_print_flags_TRUSTED_DOM_PASS(struct ndr_print *ndr, const char *name, int unused, const struct TRUSTED_DOM_PASS *r)
{
...
static void ndr_print_flags_lsa_secret(struct ndr_print *ndr, const char *name, int unused, const struct lsa_secret *r)
{
...
static void ndr_print_flags_secrets_domain_info1(struct ndr_print *ndr, const char *name, int unused, const struct secrets_domain_info1 *r)
{
...
static void ndr_print_flags_secrets_domain_infoB(struct ndr_print *ndr, const char *name, int unused, const struct secrets_domain_infoB *r)
{
