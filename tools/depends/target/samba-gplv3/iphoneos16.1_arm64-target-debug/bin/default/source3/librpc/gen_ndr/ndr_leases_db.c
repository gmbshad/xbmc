...
static void ndr_print_flags_leases_db_key(struct ndr_print *ndr, const char *name, int unused, const struct leases_db_key *r)
{
...
static void ndr_print_flags_leases_db_file(struct ndr_print *ndr, const char *name, int unused, const struct leases_db_file *r)
{
...
static void ndr_print_flags_leases_db_value(struct ndr_print *ndr, const char *name, int unused, const struct leases_db_value *r)
{
