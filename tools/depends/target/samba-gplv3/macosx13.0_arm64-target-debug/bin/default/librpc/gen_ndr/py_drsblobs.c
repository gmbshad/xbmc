...
{
	struct PlaintextSecret *object = (struct PlaintextSecret *)pytalloc_get_ptr(obj);
	PyObject *py_cleartext;
	py_cleartext = PyBytes_FromStringAndSize((char *)(object->cleartext).data, (object->cleartext).length);
	return py_cleartext;
}
...
{
	struct PlaintextSecret *object = (struct PlaintextSecret *)pytalloc_get_ptr(py_obj);
	if (value == NULL) {
		PyErr_Format(PyExc_AttributeError, "Cannot delete NDR object: struct object->cleartext");
		return -1;
	}
...
{
	struct EncryptedSecretHeader *object = (struct EncryptedSecretHeader *)pytalloc_get_ptr(obj);
	PyObject *py_magic;
...
{
	struct EncryptedSecretHeader *object = (struct EncryptedSecretHeader *)pytalloc_get_ptr(py_obj);
	if (value == NULL) {
...
{
	struct EncryptedSecret *object = (struct EncryptedSecret *)pytalloc_get_ptr(obj);
	PyObject *py_iv;
...
{
	struct EncryptedSecret *object = (struct EncryptedSecret *)pytalloc_get_ptr(py_obj);
	if (value == NULL) {
