...
static NTSTATUS clusapi__op_dispatch(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, void *r)
{
	...
	case 148: {
		...
		r2->out.result = dcesrv_Opnum148NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum148NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 149: {
		...
		r2->out.result = dcesrv_Opnum149otUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum149otUsedOnWire will reply async\n"));
		}
		break;
	}
	case 150: {
		...
		r2->out.result = dcesrv_Opnum150NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum150NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 151: {
		...
		r2->out.result = dcesrv_Opnum151NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum151NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 152: {
		...
		r2->out.result = dcesrv_Opnum152NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum152NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 153: {
		...
		r2->out.result = dcesrv_Opnum153NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum153NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 154: {
		...
		r2->out.result = dcesrv_Opnum154NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum154NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 155: {
		...
		r2->out.result = dcesrv_clusapi_AddNotifyResourceTypeV2(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_AddNotifyResourceTypeV2 will reply async\n"));
		}
		break;
	}
	case 156: {
		...
		r2->out.result = dcesrv_Opnum156NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum156NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 157: {
		...
		r2->out.result = dcesrv_clusapi_ExecuteReadBatchEx(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_ExecuteReadBatchEx will reply async\n"));
		}
		break;
	}
	case 158: {
		...
		r2->out.result = dcesrv_Opnum158NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum158NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 159: {
		...
		r2->out.result = dcesrv_Opnum159NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum159NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 160: {
		...
		r2->out.result = dcesrv_Opnum160NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum160NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 161: {
		...
		r2->out.result = dcesrv_Opnum161NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum161NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 162: {
		...
		r2->out.result = dcesrv_Opnum162NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum162NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 163: {
		...
		dcesrv_clusapi_CreateGroupSet(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_CreateGroupSet will reply async\n"));
		}
		break;
	}
	case 164: {
		...
		dcesrv_clusapi_OpenGroupSet(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_OpenGroupSet will reply async\n"));
		}
		break;
	}
	case 165: {
		...
		r2->out.result = dcesrv_clusapi_CloseGroupSet(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_CloseGroupSet will reply async\n"));
		}
		break;
	}
	case 166: {
		...
		r2->out.result = dcesrv_clusapi_DeleteGroupSet(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_DeleteGroupSet will reply async\n"));
		}
		break;
	}
	case 167: {
		...
		r2->out.result = dcesrv_clusapi_AddGroupToGroupSet(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_AddGroupToGroupSet will reply async\n"));
		}
		break;
	}
	case 168: {
		...
		r2->out.result = dcesrv_clusapi_RemoveGroupFromGroupSet(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_RemoveGroupFromGroupSet will reply async\n"));
		}
		break;
	}
	case 169: {
		...
		r2->out.result = dcesrv_clusapi_MoveGroupToGroupSet(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_MoveGroupToGroupSet will reply async\n"));
		}
		break;
	}
	case 170: {
		...
		r2->out.result = dcesrv_Opnum170NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum170NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 171: {
		...
		r2->out.result = dcesrv_clusapi_AddGroupSetDependency(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_AddGroupSetDependency will reply async\n"));
		}
		break;
	}
	case 172: {
		...
		r2->out.result = dcesrv_clusapi_AddGroupToGroupSetDependency(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_AddGroupToGroupSetDependency will reply async\n"));
		}
		break;
	}
	case 173: {
		...
		r2->out.result = dcesrv_clusapi_NodeGroupSetControl(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_NodeGroupSetControl will reply async\n"));
		}
		break;
	}
	case 174: {
		...
		r2->out.result = dcesrv_clusapi_GroupSetControl(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_GroupSetControl will reply async\n"));
		}
		break;
	}
	case 175: {
		...
		r2->out.result = dcesrv_clusapi_SetGroupDependencyExpression(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_SetGroupDependencyExpression will reply async\n"));
		}
		break;
	}
	case 176: {
		...
		r2->out.result = dcesrv_clusapi_RemoveClusterGroupDependency(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_RemoveClusterGroupDependency will reply async\n"));
		}
		break;
	}
	case 177: {
		...
		r2->out.result = dcesrv_clusapi_SetGroupSetDependencyExpression(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_SetGroupSetDependencyExpression will reply async\n"));
		}
		break;
	}
	case 178: {
		...
		r2->out.result = dcesrv_clusapi_RemoveGroupSetDependency(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_RemoveGroupSetDependency will reply async\n"));
		}
		break;
	}
	case 179: {
		...
		r2->out.result = dcesrv_clusapi_RemoveClusterGroupToGroupSetDependency(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_RemoveClusterGroupToGroupSetDependency will reply async\n"));
		}
		break;
	}
	case 180: {
		...
		r2->out.result = dcesrv_clusapi_CreateGroupSetEnum(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_CreateGroupSetEnum will reply async\n"));
		}
		break;
	}
	case 181: {
		...
		r2->out.result = dcesrv_clusapi_CreateNetInterfaceEnum(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_CreateNetInterfaceEnum will reply async\n"));
		}
		break;
	}
	case 182: {
		...
		r2->out.result = dcesrv_clusapi_ChangeCsvStateEx(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_ChangeCsvStateEx will reply async\n"));
		}
		break;
	}
	case 183: {
		...
		r2->out.result = dcesrv_clusapi_AddGroupToGroupSetEx(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function clusapi_AddGroupToGroupSetEx will reply async\n"));
		}
		break;
	}
...
static NTSTATUS clusapi__op_reply(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, void *r)
{
	...
	case 148: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum148NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 149: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum149otUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 150: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum150NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 151: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum151NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 152: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum152NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 153: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum153NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 154: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum154NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 155: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_AddNotifyResourceTypeV2\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 156: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum156NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 157: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_ExecuteReadBatchEx\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 158: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum158NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 159: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum159NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 160: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum160NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 161: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum161NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 162: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum162NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 163: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_CreateGroupSet\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 164: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_OpenGroupSet\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 165: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_CloseGroupSet\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 166: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_DeleteGroupSet\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 167: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_AddGroupToGroupSet\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 168: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_RemoveGroupFromGroupSet\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 169: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_MoveGroupToGroupSet\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 170: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum170NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 171: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_AddGroupSetDependency\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 172: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_AddGroupToGroupSetDependency\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 173: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_NodeGroupSetControl\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 174: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_GroupSetControl\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 175: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_SetGroupDependencyExpression\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 176: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_RemoveClusterGroupDependency\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 177: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_SetGroupSetDependencyExpression\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 178: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_RemoveGroupSetDependency\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 179: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_RemoveClusterGroupToGroupSetDependency\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 180: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_CreateGroupSetEnum\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 181: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_CreateNetInterfaceEnum\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 182: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_ChangeCsvStateEx\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 183: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in clusapi_AddGroupToGroupSetEx\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
...
static NTSTATUS clusapi__op_init_server(struct dcesrv_context *dce_ctx, const struct dcesrv_endpoint_server *ep_server)
{
	...
	const char *ncacn_np_secondary_endpoint =
		DCESRV_INTERFACE_CLUSAPI_NCACN_NP_SECONDARY_ENDPOINT;
#else
