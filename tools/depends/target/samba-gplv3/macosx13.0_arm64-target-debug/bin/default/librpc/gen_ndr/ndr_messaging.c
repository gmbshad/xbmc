...
static void ndr_print_flags_messaging_rec(struct ndr_print *ndr, const char *name, int unused, const struct messaging_rec *r)
{
...
static void ndr_print_flags_messaging_reclog(struct ndr_print *ndr, const char *name, int unused, const struct messaging_reclog *r)
{
