...
static enum ndr_err_code ndr_push_xattr_DosInfo4(struct ndr_push *ndr, int ndr_flags, const struct xattr_DosInfo4 *r)
{
	NDR_PUSH_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_push_align(ndr, 4));
...
static enum ndr_err_code ndr_pull_xattr_DosInfo4(struct ndr_pull *ndr, int ndr_flags, struct xattr_DosInfo4 *r)
{
	NDR_PULL_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_pull_align(ndr, 4));
...
static void ndr_print_flags_xattr_DosAttrib(struct ndr_print *ndr, const char *name, int unused, const struct xattr_DosAttrib *r)
{
...
static void ndr_print_flags_xattr_DosEAs(struct ndr_print *ndr, const char *name, int unused, const struct xattr_DosEAs *r)
{
...
static void ndr_print_flags_tdb_xattrs(struct ndr_print *ndr, const char *name, int unused, const struct tdb_xattrs *r)
{
...
static void ndr_print_flags_xattr_DosStreams(struct ndr_print *ndr, const char *name, int unused, const struct xattr_DosStreams *r)
{
...
static void ndr_print_flags_security_descriptor_hash_v2(struct ndr_print *ndr, const char *name, int unused, const struct security_descriptor_hash_v2 *r)
{
...
static void ndr_print_flags_security_descriptor_hash_v3(struct ndr_print *ndr, const char *name, int unused, const struct security_descriptor_hash_v3 *r)
{
...
static void ndr_print_flags_security_descriptor_hash_v4(struct ndr_print *ndr, const char *name, int unused, const struct security_descriptor_hash_v4 *r)
{
...
static void ndr_print_flags_xattr_NTACL(struct ndr_print *ndr, const char *name, int unused, const struct xattr_NTACL *r)
{
...
static void ndr_print_flags_xattr_sys_acl_hash_wrapper(struct ndr_print *ndr, const char *name, int unused, const struct xattr_sys_acl_hash_wrapper *r)
{
