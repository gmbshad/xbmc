...
static void ndr_print_flags_eventlog_Record_tdb(struct ndr_print *ndr, const char *name, int unused, const struct eventlog_Record_tdb *r)
{
...
static void ndr_print_flags_EVENTLOGHEADER(struct ndr_print *ndr, const char *name, int unused, const struct EVENTLOGHEADER *r)
{
...
static void ndr_print_flags_EVENTLOGRECORD(struct ndr_print *ndr, const char *name, int unused, const struct EVENTLOGRECORD *r)
{
...
static void ndr_print_flags_EVENTLOGEOF(struct ndr_print *ndr, const char *name, int unused, const struct EVENTLOGEOF *r)
{
...
static void ndr_print_flags_EVENTLOG_EVT_FILE(struct ndr_print *ndr, const char *name, int unused, const struct EVENTLOG_EVT_FILE *r)
{
...
static void ndr_print_flags_EVENTLOG_FULL_INFORMATION(struct ndr_print *ndr, const char *name, int unused, const struct EVENTLOG_FULL_INFORMATION *r)
{
