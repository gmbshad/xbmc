...
static PyObject *py_server_id_get_task_id(PyObject *obj, void *closure)
{
	struct server_id *object = (struct server_id *)pytalloc_get_ptr(obj);
	PyObject *py_task_id;
	py_task_id = PyLong_FromUnsignedLongLong((uint32_t)object->task_id);
	return py_task_id;
}
...
static PyObject *py_server_id_get_vnn(PyObject *obj, void *closure)
{
	struct server_id *object = (struct server_id *)pytalloc_get_ptr(obj);
	PyObject *py_vnn;
	py_vnn = PyLong_FromUnsignedLongLong((uint32_t)object->vnn);
	return py_vnn;
}
...
static PyObject *py_server_id_get_unique_id(PyObject *obj, void *closure)
{
	...
	py_unique_id = PyLong_FromUnsignedLongLong(object->unique_id);
	return py_unique_id;
}
...
static PyObject *py_server_id_ndr_pack(PyObject *py_obj,  PyObject *Py_UNUSED(ignored))
{
	struct server_id *object = (struct server_id *)pytalloc_get_ptr(py_obj);
	PyObject *ret = NULL;
	DATA_BLOB blob;
...
static PyObject *py_server_id_ndr_print(PyObject *py_obj, PyObject *Py_UNUSED(ignored))
{
	struct server_id *object = (struct server_id *)pytalloc_get_ptr(py_obj);
	PyObject *ret;
	char *retstr;
...
static PyMethodDef py_server_id_methods[] = {
	...
	{ "__ndr_unpack__", PY_DISCARD_FUNC_SIG(PyCFunction,py_server_id_ndr_unpack), METH_VARARGS|METH_KEYWORDS, "S.ndr_unpack(class, blob, allow_remaining=False) -> None\nNDR unpack" },
...
MODULE_INIT_FUNC(server_id)
{
	...
	PyModule_AddObject(m, "NONCLUSTER_VNN", PyLong_FromUnsignedLongLong(0xFFFFFFFF));
	PyModule_AddObject(m, "SERVERID_UNIQUE_ID_NOT_TO_VERIFY", PyLong_FromUnsignedLongLong(0xFFFFFFFFFFFFFFFFULL));
