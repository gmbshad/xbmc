...
static void ndr_print_flags_frsrpc_CommPktChangeOrderCommand(struct ndr_print *ndr, const char *name, int unused, const struct frsrpc_CommPktChangeOrderCommand *r)
{
...
static void ndr_print_flags_frsrpc_CommPktChunk(struct ndr_print *ndr, const char *name, int unused, const struct frsrpc_CommPktChunk *r)
{
...
static void ndr_print_flags_frsrpc_FrsSendCommPktReq(struct ndr_print *ndr, const char *name, int unused, const struct frsrpc_FrsSendCommPktReq *r)
{
...
static void ndr_print_flags_frsrpc_StageHeader(struct ndr_print *ndr, const char *name, int unused, const struct frsrpc_StageHeader *r)
{
