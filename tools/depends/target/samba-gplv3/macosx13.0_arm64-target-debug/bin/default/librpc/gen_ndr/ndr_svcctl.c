...
static void ndr_print_flags_SERVICE_STATUS_PROCESS(struct ndr_print *ndr, const char *name, int unused, const struct SERVICE_STATUS_PROCESS *r)
{
...
static void ndr_print_flags_ENUM_SERVICE_STATUSW(struct ndr_print *ndr, const char *name, int unused, const struct ENUM_SERVICE_STATUSW *r)
{
...
static void ndr_print_flags_ENUM_SERVICE_STATUSA(struct ndr_print *ndr, const char *name, int unused, const struct ENUM_SERVICE_STATUSA *r)
{
...
static void ndr_print_flags_QUERY_SERVICE_CONFIG(struct ndr_print *ndr, const char *name, int unused, const struct QUERY_SERVICE_CONFIG *r)
{
...
static void ndr_print_flags_SERVICE_DESCRIPTION(struct ndr_print *ndr, const char *name, int unused, const struct SERVICE_DESCRIPTION *r)
{
...
static void ndr_print_flags_SERVICE_FAILURE_ACTIONS(struct ndr_print *ndr, const char *name, int unused, const struct SERVICE_FAILURE_ACTIONS *r)
{
	ndr_print_SERVICE_FAILURE_ACTIONS(ndr, name, r);
}
...
_PUBLIC_ enum ndr_err_code ndr_push_svcctl_ChangeServiceConfigW(struct ndr_push *ndr, int flags, const struct svcctl_ChangeServiceConfigW *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		if (r->in.handle == NULL) {
...
_PUBLIC_ enum ndr_err_code ndr_pull_svcctl_ChangeServiceConfigW(struct ndr_pull *ndr, int flags, struct svcctl_ChangeServiceConfigW *r)
{
...
static const struct ndr_interface_public_struct svcctl_public_structs[] = {
	...
	},
	{
		...
		.struct_size = sizeof(struct SERVICE_FAILURE_ACTIONS ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_SERVICE_FAILURE_ACTIONS,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_SERVICE_FAILURE_ACTIONS,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_SERVICE_FAILURE_ACTIONS,
	},
	{ .name = NULL }
};
