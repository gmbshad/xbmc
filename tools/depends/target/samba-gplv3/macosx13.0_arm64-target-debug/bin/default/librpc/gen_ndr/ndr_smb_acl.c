...
_PUBLIC_ enum ndr_err_code ndr_pull_smb_acl_t(struct ndr_pull *ndr, int ndr_flags, struct smb_acl_t *r)
{
	...
	if (ndr_flags & NDR_SCALARS) {
		...
		NDR_CHECK(ndr_get_array_size(ndr, (void*)&r->acl, &size_acl_0));
...
static void ndr_print_flags_smb_acl_t(struct ndr_print *ndr, const char *name, int unused, const struct smb_acl_t *r)
{
	ndr_print_smb_acl_t(ndr, name, r);
}
...
static void ndr_print_flags_smb_acl_wrapper(struct ndr_print *ndr, const char *name, int unused, const struct smb_acl_wrapper *r)
{
	ndr_print_smb_acl_wrapper(ndr, name, r);
}
...
#ifndef SKIP_NDR_TABLE_smb_acl
static const struct ndr_interface_public_struct smb_acl_public_structs[] = {
	{
		.name = "smb_acl_t",
		.struct_size = sizeof(struct smb_acl_t ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_smb_acl_t,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_smb_acl_t,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_smb_acl_t,
	},
	{
		.name = "smb_acl_wrapper",
		.struct_size = sizeof(struct smb_acl_wrapper ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_smb_acl_wrapper,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_smb_acl_wrapper,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_smb_acl_wrapper,
	},
	{ .name = NULL }
};

static const struct ndr_interface_call smb_acl_calls[] = {
	{ .name = NULL }
};

static const char * const smb_acl_endpoint_strings[] = {
	"ncacn_np:[\\pipe\\smb_acl]", 
};

static const struct ndr_interface_string_array smb_acl_endpoints = {
	.count	= 1,
	.names	= smb_acl_endpoint_strings
};

static const char * const smb_acl_authservice_strings[] = {
	"host", 
};

static const struct ndr_interface_string_array smb_acl_authservices = {
	.count	= 1,
	.names	= smb_acl_authservice_strings
};


const struct ndr_interface_table ndr_table_smb_acl = {
	.name		= "smb_acl",
	.num_calls	= 0,
	.calls		= smb_acl_calls,
	.num_public_structs	= 2,
	.public_structs		= smb_acl_public_structs,
	.endpoints	= &smb_acl_endpoints,
	.authservices	= &smb_acl_authservices
};

#endif /* SKIP_NDR_TABLE_smb_acl */
