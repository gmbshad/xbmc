...
static void ndr_print_flags_notify_entry(struct ndr_print *ndr, const char *name, int unused, const struct notify_entry *r)
{
...
static void ndr_print_flags_notify_entry_array(struct ndr_print *ndr, const char *name, int unused, const struct notify_entry_array *r)
{
...
static void ndr_print_flags_notify_db_entry(struct ndr_print *ndr, const char *name, int unused, const struct notify_db_entry *r)
{
...
static void ndr_print_flags_notify_array(struct ndr_print *ndr, const char *name, int unused, const struct notify_array *r)
{
...
static void ndr_print_flags_notify_event(struct ndr_print *ndr, const char *name, int unused, const struct notify_event *r)
{
...
static void ndr_print_flags_FILE_NOTIFY_INFORMATION(struct ndr_print *ndr, const char *name, int unused, const struct FILE_NOTIFY_INFORMATION *r)
{
