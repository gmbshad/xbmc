...
static void ndr_print_flags_DNS_RPC_NAME(struct ndr_print *ndr, const char *name, int unused, const struct DNS_RPC_NAME *r)
{
...
static enum ndr_err_code ndr_push_DNS_RPC_RECORD_DATA(struct ndr_push *ndr, int ndr_flags, const union DNS_RPC_RECORD_DATA *r)
{
	uint32_t level;
	{
...
static enum ndr_err_code ndr_pull_DNS_RPC_RECORD_DATA(struct ndr_pull *ndr, int ndr_flags, union DNS_RPC_RECORD_DATA *r)
{
	uint32_t level;
	{
		uint32_t _flags_save_UNION = ndr->flags;
...
static size_t ndr_size_DNS_RPC_RECORD_DATA(const union DNS_RPC_RECORD_DATA *r, uint32_t level, int flags)
{
...
static void ndr_print_flags_DNS_RPC_RECORD(struct ndr_print *ndr, const char *name, int unused, const struct DNS_RPC_RECORD *r)
{
...
static void ndr_print_flags_DNS_RPC_SERVER_INFO_DOTNET(struct ndr_print *ndr, const char *name, int unused, const struct DNS_RPC_SERVER_INFO_DOTNET *r)
{
...
static void ndr_print_flags_DNS_RPC_SERVER_INFO_LONGHORN(struct ndr_print *ndr, const char *name, int unused, const struct DNS_RPC_SERVER_INFO_LONGHORN *r)
{
...
static void ndr_print_flags_DNS_RPC_RECORDS(struct ndr_print *ndr, const char *name, int unused, const struct DNS_RPC_RECORDS *r)
{
...
static void ndr_print_flags_DNS_RPC_RECORDS_ARRAY(struct ndr_print *ndr, const char *name, int unused, const struct DNS_RPC_RECORDS_ARRAY *r)
{
