...
static void ndr_print_flags_witness_ResourceChange(struct ndr_print *ndr, const char *name, int unused, const struct witness_ResourceChange *r)
{
...
_PUBLIC_ enum ndr_err_code ndr_push_witness_IPaddrInfoList(struct ndr_push *ndr, int ndr_flags, const struct witness_IPaddrInfoList *r)
{
...
_PUBLIC_ enum ndr_err_code ndr_pull_witness_IPaddrInfoList(struct ndr_pull *ndr, int ndr_flags, struct witness_IPaddrInfoList *r)
{
...
static void ndr_print_flags_witness_IPaddrInfoList(struct ndr_print *ndr, const char *name, int unused, const struct witness_IPaddrInfoList *r)
{
...
_PUBLIC_ size_t ndr_size_witness_IPaddrInfoList(const struct witness_IPaddrInfoList *r, int flags)
{
	flags |= LIBNDR_FLAG_NOALIGN|LIBNDR_FLAG_LITTLE_ENDIAN;
...
static void ndr_print_flags_witness_notifyResponse(struct ndr_print *ndr, const char *name, int unused, const struct witness_notifyResponse *r)
{
