...
static void ndr_print_flags_COMVERSION(struct ndr_print *ndr, const char *name, int unused, const struct COMVERSION *r)
{
...
static void ndr_print_flags_ORPC_EXTENT(struct ndr_print *ndr, const char *name, int unused, const struct ORPC_EXTENT *r)
{
...
static void ndr_print_flags_ORPCTHIS(struct ndr_print *ndr, const char *name, int unused, const struct ORPCTHIS *r)
{
...
static void ndr_print_flags_ORPCTHAT(struct ndr_print *ndr, const char *name, int unused, const struct ORPCTHAT *r)
{
...
static void ndr_print_flags_STRINGBINDING(struct ndr_print *ndr, const char *name, int unused, const struct STRINGBINDING *r)
{
...
static void ndr_print_flags_STRINGARRAY(struct ndr_print *ndr, const char *name, int unused, const struct STRINGARRAY *r)
{
	ndr_print_STRINGARRAY(ndr, name, r);
}

static void ndr_print_flags_DUALSTRINGARRAY(struct ndr_print *ndr, const char *name, int unused, const struct DUALSTRINGARRAY *r)
{
...
static void ndr_print_flags_SECURITYBINDING(struct ndr_print *ndr, const char *name, int unused, const struct SECURITYBINDING *r)
{
...
static void ndr_print_flags_STDOBJREF(struct ndr_print *ndr, const char *name, int unused, const struct STDOBJREF *r)
{
...
static void ndr_print_flags_OBJREF(struct ndr_print *ndr, const char *name, int unused, const struct OBJREF *r)
{
...
static void ndr_print_flags_MInterfacePointer(struct ndr_print *ndr, const char *name, int unused, const struct MInterfacePointer *r)
{
