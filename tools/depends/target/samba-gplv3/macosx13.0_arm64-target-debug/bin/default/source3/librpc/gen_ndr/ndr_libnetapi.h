...
#define NDR_NETSERVERGETINFO (0x07)

#define NDR_NETSERVERSETINFO (0x08)

#define NDR_NETWKSTAGETINFO (0x09)

#define NDR_NETGETDCNAME (0x0a)

#define NDR_NETGETANYDCNAME (0x0b)

#define NDR_DSGETDCNAME (0x0c)

#define NDR_NETUSERADD (0x0d)

#define NDR_NETUSERDEL (0x0e)

#define NDR_NETUSERENUM (0x0f)

#define NDR_NETUSERCHANGEPASSWORD (0x10)

#define NDR_NETUSERGETINFO (0x11)

#define NDR_NETUSERSETINFO (0x12)

#define NDR_NETUSERGETGROUPS (0x13)

#define NDR_NETUSERSETGROUPS (0x14)

#define NDR_NETUSERGETLOCALGROUPS (0x15)

#define NDR_NETUSERMODALSGET (0x16)

#define NDR_NETUSERMODALSSET (0x17)

#define NDR_NETQUERYDISPLAYINFORMATION (0x18)

#define NDR_NETGROUPADD (0x19)

#define NDR_NETGROUPDEL (0x1a)

#define NDR_NETGROUPENUM (0x1b)

#define NDR_NETGROUPSETINFO (0x1c)

#define NDR_NETGROUPGETINFO (0x1d)

#define NDR_NETGROUPADDUSER (0x1e)

#define NDR_NETGROUPDELUSER (0x1f)

#define NDR_NETGROUPGETUSERS (0x20)

#define NDR_NETGROUPSETUSERS (0x21)

#define NDR_NETLOCALGROUPADD (0x22)

#define NDR_NETLOCALGROUPDEL (0x23)

#define NDR_NETLOCALGROUPGETINFO (0x24)

#define NDR_NETLOCALGROUPSETINFO (0x25)

#define NDR_NETLOCALGROUPENUM (0x26)

#define NDR_NETLOCALGROUPADDMEMBERS (0x27)

#define NDR_NETLOCALGROUPDELMEMBERS (0x28)

#define NDR_NETLOCALGROUPGETMEMBERS (0x29)

#define NDR_NETLOCALGROUPSETMEMBERS (0x2a)

#define NDR_NETREMOTETOD (0x2b)

#define NDR_NETSHAREADD (0x2c)

#define NDR_NETSHAREDEL (0x2d)

#define NDR_NETSHAREENUM (0x2e)

#define NDR_NETSHAREGETINFO (0x2f)

#define NDR_NETSHARESETINFO (0x30)

#define NDR_NETFILECLOSE (0x31)

#define NDR_NETFILEGETINFO (0x32)

#define NDR_NETFILEENUM (0x33)

#define NDR_NETSHUTDOWNINIT (0x34)

#define NDR_NETSHUTDOWNABORT (0x35)

#define NDR_I_NETLOGONCONTROL (0x36)

#define NDR_I_NETLOGONCONTROL2 (0x37)

#define NDR_LIBNETAPI_CALL_COUNT (56)
...
enum ndr_err_code ndr_push_NetProvisionFlags(struct ndr_push *ndr, int ndr_flags, uint32_t r);
enum ndr_err_code ndr_pull_NetProvisionFlags(struct ndr_pull *ndr, int ndr_flags, uint32_t *r);
void ndr_print_NetProvisionFlags(struct ndr_print *ndr, const char *name, uint32_t r);
enum ndr_err_code ndr_push_NetProvisionJoinFlags(struct ndr_push *ndr, int ndr_flags, uint32_t r);
enum ndr_err_code ndr_pull_NetProvisionJoinFlags(struct ndr_pull *ndr, int ndr_flags, uint32_t *r);
...
enum ndr_err_code ndr_push_NetProvisionComputerAccount(struct ndr_push *ndr, int flags, const struct NetProvisionComputerAccount *r);
enum ndr_err_code ndr_pull_NetProvisionComputerAccount(struct ndr_pull *ndr, int flags, struct NetProvisionComputerAccount *r);
void ndr_print_NetProvisionComputerAccount(struct ndr_print *ndr, const char *name, int flags, const struct NetProvisionComputerAccount *r);
enum ndr_err_code ndr_push_NetRequestOfflineDomainJoin(struct ndr_push *ndr, int flags, const struct NetRequestOfflineDomainJoin *r);
enum ndr_err_code ndr_pull_NetRequestOfflineDomainJoin(struct ndr_pull *ndr, int flags, struct NetRequestOfflineDomainJoin *r);
void ndr_print_NetRequestOfflineDomainJoin(struct ndr_print *ndr, const char *name, int flags, const struct NetRequestOfflineDomainJoin *r);
