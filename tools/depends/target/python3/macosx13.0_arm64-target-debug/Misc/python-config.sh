...
CFLAGS=$(echo "-fheinous-gnu-extensions -ftree-vectorize -pipe -Wno-trigraphs -fpascal-strings -Wreturn-type -Wunused-variable -fmessage-length=0 -gdwarf-2 -g -D_DEBUG  -arch arm64 -mmacosx-version-min=11.0 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk -isystem /Users/Shared/xbmc-depends/macosx13.0_arm64-target-debug/include " | sed "s#$prefix#$prefix_real#")
VERSION="3.11"
LIBM=""
LIBC=""
SYSLIBS="$LIBM $LIBC"
