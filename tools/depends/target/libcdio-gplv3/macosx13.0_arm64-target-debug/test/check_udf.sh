...
if test "X$abs_top_srcdir" = "X" ; then
  abs_top_srcdir=/Users/redd/kodi/tools/depends/target/libcdio-gplv3/macosx13.0_arm64-target-debug
fi

if test "X$top_builddir" = "X" ; then
  top_builddir=/Users/redd/kodi/tools/depends/target/libcdio-gplv3/macosx13.0_arm64-target-debug
fi
