...
execute_process(
  COMMAND "/usr/bin/git" show-ref "Omega"
  WORKING_DIRECTORY "/Users/redd/kodi/tools/depends/target/binary-addons/macosx13.0_x86_64-target-debug/build/bootstrap/binary-addons/src/binary-addons"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("Omega" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/Omega")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/redd/kodi/tools/depends/target/binary-addons/macosx13.0_x86_64-target-debug/build/bootstrap/binary-addons/src/binary-addons'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/redd/kodi/tools/depends/target/binary-addons/macosx13.0_x86_64-target-debug/build/bootstrap/binary-addons/src/binary-addons'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
