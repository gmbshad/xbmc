...
#define LIBS_SYS "-l/Users/Shared/xbmc-depends/iphoneos16.1_arm64-target-debug/lib/libssl.a -l/Users/Shared/xbmc-depends/iphoneos16.1_arm64-target-debug/lib/libcrypto.a"
#define CFLAGS  INCLUDE
#define VERSION "10.8.4"
#define CC_VERSION "3.3.2"
#define PLUGIN_DIR "%s/lib/mariadb/plugin"
#define SOCKET  "/tmp/mysql.sock"
#define PORT "3306"
#ifdef HAVE_TLS
#define TLS_LIBRARY_VERSION "OpenSSL 1.1.1n"
#else
...
#ifdef HAVE_EMBEDDED
#define EMBEDDED_LIBS "-L/Users/Shared/xbmc-depends/iphoneos16.1_arm64-target-debug/lib/mariadb/ -lmariadbd -l/Users/Shared/xbmc-depends/iphoneos16.1_arm64-target-debug/lib/libssl.a -l/Users/Shared/xbmc-depends/iphoneos16.1_arm64-target-debug/lib/libcrypto.a"
#endif
...
void usage(void)
{
  ...
  printf("Compiler: Clang 14.0.0.14000029\n");
...
static void mariadb_get_install_location()
{
  ...
  if (!p || !p[0])
  {
    strncpy(installation_dir, "/Users/Shared/xbmc-depends/iphoneos16.1_arm64-target-debug", PATH_MAX - 1);
    return;
  }
}
