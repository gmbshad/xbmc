...
foreach(_cmake_expected_target IN ITEMS LibXslt::LibXslt LibXslt::LibExslt LibXslt::xsltproc)
...
set_target_properties(LibXslt::LibExslt PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:Gcrypt::Gcrypt>;LibXslt::LibXslt;LibXml2::LibXml2"
)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/libxslt-export-*.cmake")
